...
export default function SignupForm() {
  ...
  const handleGithubSignUp = async () => {
    ...
    if (githubError) {
      setError(githubError.message || 'Failed to sign up with GitHub');
    }
  };
      ...
      <div className="auth-form-container max-w-md mx-auto p-6">
        <div className="success-message text-center">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Click the link in the email to verify your account and start using LAB Visualization
            Platform.
          </p>
          <Link href="/auth/login" className="btn-primary inline-block px-6 py-3 rounded-lg">
            Go to login
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="auth-form-container max-w-md mx-auto p-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Join LAB Visualization Platform</p>
      </div>
      ...
      <div className="space-y-4 mb-6">
        <button
          ...
          className="oauth-button w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition"
        >
